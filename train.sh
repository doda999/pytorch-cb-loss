...
# loss_type="softmax"
# for beta in 0 0.9 0.99 0.999 0.999
# do
#     echo "python -data_dir ${data_dir}/cifar-${dataset_type}-data-im-${imbalance_factor} -save_path logs/cifar${dataset_type}-im-${imbalance_factor}-${loss_type} -beta ${beta} -loss_type ${loss_type}"
